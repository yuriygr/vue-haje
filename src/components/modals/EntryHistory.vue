...
import { Modal, ModalHeader, ModalBody, NButton, LoadmoreTrigger, IconButton, Placeholder, PlaceholderLoading, Separator } from '@vue-norma/ui'
...
export default {
  ...
  components: {
    ...
    NButton, LoadmoreTrigger, IconButton, Placeholder, PlaceholderLoading, Separator,
    EntryHistoryItem
  },
  props: {
    uuid: {
